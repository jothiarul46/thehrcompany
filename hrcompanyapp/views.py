...
def appointment(request):
    if request.method == 'POST':
        ...
        # Normalize the time format to include seconds
        try:
        ...
        # Convert `date` and `normalized_time` to a datetime object for comparison
        try:
        ...
        for existing in existing_appointments:
            ...
            # Check if the new appointment is within 30 minutes of any existing appointment
        ...
        # Save the new appointment if no conflict exists
